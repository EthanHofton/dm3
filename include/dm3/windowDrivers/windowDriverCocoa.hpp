#ifndef DM3_WINDOWDRIVERS_WINDOW_DRIVER_COCOA_HPP
#define DM3_WINDOWDRIVERS_WINDOW_DRIVER_COCOA_HPP
...
#import <dm3/windowDrivers/windowDelegate.h>

namespace dm3 {

class windowDriverCocoa : public windowDriver {
public:

    windowDriverCocoa();
    virtual ~windowDriverCocoa() override;
